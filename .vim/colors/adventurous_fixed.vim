...
let colors_name = 'adventurous_fixed'

if &t_Co >= 256 || has('gui_running')
    hi Normal            ctermbg=NONE ctermfg=188 guibg=#191B1F guifg=#c5c8c6 cterm=NONE gui=NONE
    ...
    hi CursorColumn      ctermbg=235   ctermfg=NONE guibg=#24262A guifg=NONE    cterm=NONE           gui=NONE
    " hi CursorColumn      ctermbg=16   ctermfg=NONE guibg=#191B1F guifg=NONE    cterm=NONE           gui=NONE
    hi CursorLine        ctermbg=235  ctermfg=NONE guibg=#24262A guifg=NONE    cterm=NONE           gui=NONE
    ...
    hi Visual            ctermbg=238  ctermfg=NONE guibg=#403D3D guifg=NONE    cterm=NONE           gui=NONE
